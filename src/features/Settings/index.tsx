...
import { config, setConfig, drawer, setDrawer, cssVar, themer, quickSwitch } from '@utils';
  ...
  return (
    ...
    >
      <header>
        ...
        <i
          aria-label={t('close')}
          class="ri-close-large-line" onclick={() => setNavStore('active', drawer.lastMainFeature || 'home')}></i>
        <Dropdown />
      </header>
      <div>
        {/* App Settings */}
        ...
        <Toggle
          name='settings_prefer_lossless'
          checked={Boolean(config.preferLossless)}
          onclick={() => {
            setConfig('preferLossless', !config.preferLossless);
            quickSwitch();
          }}
        />
